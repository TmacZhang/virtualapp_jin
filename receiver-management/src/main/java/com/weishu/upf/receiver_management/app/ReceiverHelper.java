...
public final class ReceiverHelper {
    ...
    public static void hookDynamicReceiver(Context context, File apk, String packageName, String receivername, String intentFilterName) {
            /**
             * 动态receiver的hook，首先apk是知道的，packageName也知道，receivername，intentFilterName也知道。
             */
            if (cl == null) {
                try {
                    cl = CustomClassLoader.getPluginClassLoader(apk, packageName);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            try {
                receiver = (BroadcastReceiver) cl.loadClass(receivername).newInstance();
                intentFilter = (IntentFilter) cl.loadClass(intentFilterName).newInstance();
                context.registerReceiver(receiver,intentFilter);
                Log.i("jin","hookDynamicReceiver " + receiver +"  " +intentFilter );
    ...
    public static void hookUnDynamicReceiver(Context context, File apk, String packageName, String receivername, String intentFilterName) {
        /**
         * 动态receiver的hook，首先apk是知道的，packageName也知道，receivername，intentFilterName也知道。
         */
        if (cl == null) {
