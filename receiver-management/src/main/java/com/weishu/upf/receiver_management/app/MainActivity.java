...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.extractAssets(this, "TestReceiver.jar");
        File testDynamicPlugin = getFileStreamPath("TestReceiver.jar");
        try {
            //  ReceiverHelper.preLoadReceiver(this, testPlugin);
            Log.i(getClass().getSimpleName(), "hook success");
            ReceiverHelper.hookDynamicReceiver(this, testDynamicPlugin, "com.example.testreceiver", "com.example.testreceiver.TestReceiver", "com.example.testreceiver.TestIntentFilter");
        } catch (Exception e) {
    ...
    protected void onDestroy() {
        ...
        Utils.extractAssets(this, "TestReceiver.jar");
        File testDynamicPlugin = getFileStreamPath("TestReceiver.jar");
        ReceiverHelper.hookUnDynamicReceiver(this, testDynamicPlugin, "com.example.testreceiver", "com.example.testreceiver.TestReceiver", "com.example.testreceiver.TestIntentFilter");
    }
}
